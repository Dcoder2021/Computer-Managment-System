...
namespace Computer_Managment_System.Classes
{
    class orderDBUtill
    {
        ...
        public static bool insert(Order o)
        {
            ...
            {
                //sql query
                string sql = "INSERT INTO tbl_Order(Date, SID, Name, Brand, Amount, Status) VALUES(@Date, @SID, @Name, @Brand, @Amount, @Status)";
        ...
        public static int getOrderID()
        {
            ...
            try
            {
                ...
                //sql query
                string sql = "SELECT TOP 1 * FROM tbl_Order ORDER BY OrderID DESC";
        ...
        public static void SelectOrder(ref DataTable orderDT, ref DataTable itemDT, int oid)
        {
            ...
            try
            {
                ...
                string sql_2 = "SELECT * FROM tbl_Order WHERE OrderID = '" + oid + "'";
        ...
        public static bool Delete(Order o)
        {
            ...
            try
            {
                ...
                string sql_2 = "DELETE FROM tbl_Order WHERE OrderID=@id";
        ...
        public static DataTable Search(string key)
        {
            ...
            {
                //sql query
                string sql = "SELECT * FROM tbl_order WHERE Name LIKE '%" + key + "%' OR Brand LIKE '%" + key + "%' OR Status LIKE '%" + key + "%' OR OrderID LIKE '%" + key + "%'";
        ...
        public static bool completeOrder(Order o)
        {
            ...
            try
            {
                ...
                //sql query
                string sql = "UPDATE tbl_Order SET Status=@Status WHERE OrderID=@orderID ";
